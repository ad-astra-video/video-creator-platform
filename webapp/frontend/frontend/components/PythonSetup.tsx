  ...
  return (
    <div className="h-screen flex flex-col" style={{
      ...
      <div style={{
        ...
        <span style={{ fontSize: 13, color: '#a0a0a0' }}>Video Creator</span>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 11, color: '#666' }}>&copy; 2026 ad-astra-video &middot; Fork of Lightricks' LTX Desktop</div>
        </div>
      </div>
    </div>
  )
