...
export interface paths {
    ...
    "/api/providers/discover": {
        ...
        /**
         * Discover Providers
         * @description Trigger a fresh discovery sweep against the *current* discovery URL.
         */
    ...
    "/api/restyle/segment-subject": {
        ...
        get?: never;
        put?: never;
        /** Route Segment Subject */
        post: operations["route_segment_subject_api_restyle_segment_subject_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/restyle/style-frame": {
        ...
        get?: never;
        put?: never;
        /** Route Style First Frame */
        post: operations["route_style_first_frame_api_restyle_style_frame_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        /**
         * StyleFirstFrameRequest
         * @description Style a restyle first frame with FLUX.2 [klein] 4B (id-v2v worker).
         *
         *     The image-edit half of the restyle workflow. Unlike the legacy Z-Image
         *     img2img path (strength / keep-subject / SAM3 mask), FLUX.2 klein 4B is a
         *     fixed 4-step distilled single-reference editor: it takes the reference frame
         *     + a prompt describing the DESIRED (styled) result (+ optional seed / dims)
         *     and applies a whole-frame style transform.
         */
        StyleFirstFrameRequest: {
            /**
             * Enhance Prompt
        ...
        /**
         * StyleFirstFrameResponse
         * @description Path to the FLUX.2-styled first frame image (PNG) + LLM artifacts.
         */
        StyleFirstFrameResponse: {
            /** Enhancedprompt */
...
export interface operations {
    ...
    route_segment_subject_api_restyle_segment_subject_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SegmentSubjectRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["SegmentSubjectResponse"];
                };
            };
            /** @description Client Error */
            "4XX": {
    ...
    route_style_first_frame_api_restyle_style_frame_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["StyleFirstFrameRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["StyleFirstFrameResponse"];
                };
            };
            /** @description Client Error */
            "4XX": {
